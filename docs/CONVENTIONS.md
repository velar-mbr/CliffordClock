...
## 21. Differentiable Rydberg field-to-spectrum chain and gradient-based field reconstruction (v1.17.0, WP41)
...
**Section numbering.** WP40's Stark-map work occupies section 20 and extends E44; this section's number (21) and equation label (E45) are final.
...
---
*Changelog:*
*1.17.0 (2026-09-04): WP41, specified directly by the project owner (no
...
final: WP40's Stark-map work occupies section 20, so this section is
21 and its label is E45.*
