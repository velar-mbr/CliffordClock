...
fractional shift is the mean of the resulting ensemble phase
...
under the standard Gaussian-phase closure. The additive
...
both at least twelve orders of magnitude below the $10^{-18}$-$10^{-19}$
...
it adds beyond first order sit at least twelve orders of magnitude below
...
fringe contrast recovered from the phase variance of the same object, in
...
$-3.33(3)\times10^{-15}$, landing within $5.011\times10^{-18}$ of
