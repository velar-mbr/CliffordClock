...
the next two steps expose. Supplying only the participation correction,
steps two and three, removes that accidental cancellation without
...
factor on the same per-mode rate, steps four and five, closes most of that
