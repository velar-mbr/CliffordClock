...
correlated because they multiply the same per-mode rate, which is what
closed the budget of Sec.~\ref{sec:motional}, and the shift and the
fringe contrast come out of one calculation. The full rule fits in the
